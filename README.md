...
- Áp dụng kiến trúc event-driven + Medallion Architecture (Bronze / Silver / Gold)
- Xử lý streaming data với Kafka + Spark Structured Streaming
- Điều phối pipeline tự động bằng Apache Airflow
- Tối ưu khả năng mở rộng và chịu tải cao nhờ kiến trúc phân tách rõ ràng
- Giám sát hệ thống real-time bằng Kafka UI giúp phát hiện lỗi nhanh
...
## 4. Use Case
  - Phân tích hành vi người dùng trong game (login, purchase, ...) theo thời gian thực
  - Hỗ trợ giám sát hệ thống streaming và phát hiện vấn đề dữ liệu sớm
  - Cung cấp dữ liệu phục vụ dashboard và phân tích sản phẩm game
